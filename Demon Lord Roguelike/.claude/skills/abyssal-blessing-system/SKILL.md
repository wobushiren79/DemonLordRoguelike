...
> **已释放 id 段**：单行族 `1000004xxx~1000007xxx`、多级族号 2~13（`2000002xxx~2000013xxx`）、BUFF 族号 3~8 与 11~20（`30003xxxxx~30008xxxxx`、`30011xxxxx~30020xxxxx`）。闲置图标 `ui_abyssalblessing_1~5、8、11~14、120~125` 文件仍在图集中未删。
...
- **当前 id 进度**（2026-07 精简后）：现役深渊馈赠 BUFF 段（`buff_type=3`）→ `3000100001`、`3000200001~005`、`3000900001`、`3001000001`；BUFF 族号 3~8、11~20 与馈赠多级族号 2~13、单行族号 4~7 **已释放可复用**（也可避开历史段从新号续编）。彩色图标编号历史用到 125，其中 `ui_abyssalblessing_120~125` 等闲置未删。
