...
| `excel_buff_info[buff信息].xlsx` | BuffInfo | 80 | id, buff_type, rarity, class_entity/events/data, trigger_value/chance/num/time/effect, name[language] （24列） |
