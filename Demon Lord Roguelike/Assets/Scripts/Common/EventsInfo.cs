...
public static class EventsInfo
{
    ...
    public const string GameFightLogic_DefenseCreatureCreate = "GameFightLogic_DefenseCreatureCreate";//新建防守魔物实体(参数 FightCreatureEntity；供动态属性馈赠等按需重算全体防守属性)
    ...
    #region 游戏设置
    /// <summary>按键提示显示开关变更(无参) —— 所有 UIViewPressCommon 据此实时刷新显隐</summary>
    public const string GameSetting_PressKeyTipShowChange = "GameSetting_PressKeyTipShowChange";
    #endregion
