...
public partial class CreatureModelBean : BaseBean
{
	...
	public long name;
	[JsonIgnore]
	public string name_language { get => _name_language.Get(() => TextHandler.Instance.GetTextById(CreatureModelCfg.fileName, name)); set => _name_language.Set(value); }
...
public partial class CreatureModelCfg : BaseCfg<long, CreatureModelBean>
{
	...
	public static CreatureModelBean[] GetAllArrayData()
	{
		if (arrayData == null)
		{
